...
public class WordSplitterTest {
    ...
    public void exampleStringGivenInSpec() {
        List<String> words = WordSplitter.wordsFromString("Hello world & good morning. The date is 18/05/2016");
    ...
    public void nullStringReturnsEmptyList() {
        List<String> words = WordSplitter.wordsFromString(null);
    ...
    public void formattedNumericValueIsNotSplit() {
        List<String> words = WordSplitter.wordsFromString("350,000.56");
    ...
    public void commaFollowingNonDigitSplitsOnComma() {
        List<String> words = WordSplitter.wordsFromString("NonNumericOne,NonNumericTwo");
    ...
    public void commaBetweenDigitAndNonDigitSplitsOnComma() {
        List<String> words = WordSplitter.wordsFromString("35,NonNumeric");
    ...
    public void periodFollowingNonDigitSplitsOnPeriod() {
        List<String> words = WordSplitter.wordsFromString("NonNumericOne.350");
    ...
    public void commaAtEndOfStringFollowingADigitShouldNotBeIncludedInWord() {
        List<String> words = WordSplitter.wordsFromString("350,");
    ...
    public void commaAtStartOfStringShouldNotBeIncludedInWord() {
        List<String> words = WordSplitter.wordsFromString(",Hello");
    ...
    public void correctlySplitsOnSpace() {
        List<String> words = WordSplitter.wordsFromString("Hello World");
