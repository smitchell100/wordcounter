...
public class SingleThreadedWordCounterImplTest {


    @Test
    public void correctlyProcessesSingleLineFile() throws URISyntaxException, MalformedURLException {

        WordCounter wordCounter = new SingleThreadedWordCounter();

        WordCountMetrics wordCountMetrics = wordCounter.analyseText(getClass().getClassLoader().getResource("singleLine.txt").toURI());
